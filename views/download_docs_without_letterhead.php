...
while ($row = mysqli_fetch_assoc($items_res)) {
    ...
    $pdf->SetFont('Times', 'B', 12);
    $pdf->SetX(15);
    $pdf->Cell(100, 7, "M/S " . strtoupper($data['vendor_name']), 0, 1, 'L');
